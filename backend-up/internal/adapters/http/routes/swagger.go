...
// RegisterSwagger registra as rotas da documentacao da API:
// /swagger.json serve o arquivo OpenAPI cru, /swagger serve uma pagininha que carrega o Swagger UI via CDN
