...
import (
	...
	"up-espaco/backend/internal/adapters/database/migrations"
...
// main sobe a API: conecta no banco, roda as migrations e liga o servidor HTTP
func main() {
	cfg := config.Load()
	...
	handler := routes.NewRouter(repos, cfg.JWTSecret, cfg.TokenTTL)
